...
//print("The value of foo is \(foo)")
print("Because the constant \"foo\" is only defined inside of the for loop.")
...
print("Because x was defined outside of the for loop. In the entire code, x is defined. In the for loop, x is modified. foo is only defined in the for loop, and is used in the for loop as well. Trying to use the constant outside of the for loop wouldn't work.")
...
greeting(greeting: "What's up", name: "Sarah")
